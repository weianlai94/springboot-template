...
public class WXPay {
     ...
     * @throws Exception
     */
    public Map<String, String> fillRequestDataForRefund(Map<String, String> reqData) throws Exception {
        reqData.put("nonce_str", WXPayUtil.generateUUID());
        reqData.put("sign_type", WXPayConstants.MD5);
        reqData.put("mch_id", config.getMchID());
        reqData.put("appid", config.getAppID());
     ...
     * @throws Exception
     */
    public Map<String, String> closeOrder(Map<String, String> reqData, String payType) throws Exception {
        return this.closeOrder(reqData, config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs(), payType);
    }
     ...
     * @throws Exception
     */
    public Map<String, String> closeOrder(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs, String payType) throws Exception {
        String url;
        if (this.useSandbox) {
        ...
        String respXml = this.requestWithoutCert(url, this.fillRequestDataForCloseOrder(reqData, payType), connectTimeoutMs, readTimeoutMs);
        return this.processResponseXml(respXml);
    }
     ...
     *
     * @param reqData 向wxpay post的请求数据
     * @param payType 表示订单渠道
     * @return API返回数据
     * @throws Exception
     */
    public Map<String, String> fillRequestDataForCloseOrder(Map<String, String> reqData, String payType) throws Exception {
        reqData.put("nonce_str", WXPayUtil.generateUUID());
        reqData.put("sign_type", WXPayConstants.MD5);
        reqData.put("mch_id", config.getMchID());
        reqData.put("appid", config.getAppID());
    ...
    public Map<String, String> refund(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws Exception {
        ...
        String respXml = this.requestWithCert(url, this.fillRequestDataForRefund(reqData), connectTimeoutMs, readTimeoutMs);
